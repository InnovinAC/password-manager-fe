export const DashboardFooter = () => {
    return (
        ...
        <div
            className="fixed z-50 w-full h-16 max-w-lg -translate-x-1/2 bg-white border border-gray-200 rounded-full bottom-4 shadow-lg mx-auto left-1/2 ">
            <div className="grid h-full max-w-lg grid-cols-4 mx-auto">
                ...
                <div className="flex items-center justify-center content absolute bottom-0 left-1/2 transform -translate-x-1/2 -translate-y-full">
